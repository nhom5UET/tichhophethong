...
<div class="login">
   <div class="loginWelcome">
      <img src="'.base_url().'images/layout/hvolSolutions_01.png">
   </div>
   ...
   $passcode    = array('name' => 'passcode', 'id' => 'passcode',
                     'value'=> $formData->passcode,    'size' => 25, 'style'=>'margin-bottom: 4px;');
   ...
   echo('
         ...
         <p><label for="p">Patient Encryption Passcode (10-30 characters)</label><br />'
         .form_input($passcode).form_error('passcode').'</p>'
