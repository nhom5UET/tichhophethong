<?php
   ...
   echoT(form_open('hospice/reports/su_annual/runAnnual',  $attributes));

   openBlock('Annual Administrative Report', '');
   ...
   $clsForm->strStyleExtraLabel = 'width: 50pt; padding-top: 5px;';
