...
*/
   ...
   //---------------------------------------------------------------------
      $strVolPerm =
         '<i>Volunteer accounts have limited access to <b>Hospice Volunteer Solutions</b>. You can set<br>
      ...
      $strVolPerm .=
         '<input type="checkbox" name="chkVolEditJobSkills" value="true" '
                        .($userRec->bVolEditJobSkills ? 'checked' : '').'>Edit job skills<br>'."\n"
...
echo('<font class="debug">'.substr(__FILE__, strrpos(__FILE__, '\\'))
   .': '.__LINE__.'<br>$userRec   <pre>');
echo(htmlspecialchars( print_r($userRec, true))); echo('</pre></font><br>');
die;
// ------------------------------------- */

      $strUserPerm =
         '<i>User accounts can optionally access various features of <b>Hospice Volunteer Solutions</b>. You can set<br>
...
//---------------------------------------------------------------------
   ...
   echoT($clsForm->strGenericTextEntry('State',       'txtState',    false, $userRec->strState,   40, 40));
   echoT($clsForm->strGenericTextEntry('Country',     'txtCountry',  false, $userRec->strCountry, 40, 40));
   echoT($clsForm->strGenericTextEntry('Postal Code', 'txtZip',      false, $userRec->strZip,     15, 15));
