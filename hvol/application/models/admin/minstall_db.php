...
class minstall_db extends CI_Model{
   ...
   //---------------------------------------------------------------------
      ...
      if ($numRows!=0) {
         ...
         //------------------------------------
      $strInstallFN = set_realpath('.').'README/hospice_vol.sql';
   ...
   function updateDBConfigFile($strDBName, $strDBHost, $strUserName, $strPWord, $strPasscode){
   //---------------------------------------------------------------------
   //
   //---------------------------------------------------------------------
      ...
      $strDBConfig =
           ...
           .'  Hospice Volunteer Solutions installation. '."\n\n"
