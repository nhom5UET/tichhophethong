...
//                  .date($genumDateFormat, $dteStart).' - '.date($genumDateFormat, $dteEnd).'
   ...
   //---------------------------------------------------------------------
      ...
      $lNumRows = $query->num_rows();
      if ($lNumRows==0){
         return($strOut.'<br><i>There are no other activities logged for this volunteer..</i>');
      }
         ...
         '<table class="enpRptC">
            <tr>
               <td class="enpRptTitle" colspan="7">
                  Non-Patient Volunteer Hours by volunteer '.$strName.'&nbsp;'.$strVolLink.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
           "SELECT
              ...
              pe_strAddr1 AS `Address 1`, pe_strAddr2 AS `Address 2`,
              pe_strCity AS `City`, pe_strState AS `State`,
              pe_strCountry AS `Country`, pe_strZip AS `Zip`,
              pe_strPhone AS `Phone`, pe_strCell AS `Cell`, pe_strFax AS `Fax`,
