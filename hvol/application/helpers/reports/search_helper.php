...
define('CL_STID_CLIENT',     -1);   // patient_records
...
define('CL_STID_BIZ',        -5);   // business
   ...
   //---------------------------------------------------------------------
      switch ($strFN){
         ...
         case 'cr_strState'      : $enumFType = CS_FT_TEXT        ; $strUserFN = 'State'             ; break;
         case 'cr_strCountry'    : $enumFType = CS_FT_TEXT        ; $strUserFN = 'Country'           ; break;
         case 'cr_strZip'        : $enumFType = CS_FT_TEXT        ; $strUserFN = 'Zip'               ; break;
