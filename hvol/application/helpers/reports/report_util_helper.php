...
$strCrumb = 'TBD';
   ...
   /*---------------------------------------------------------------------
            FROM sponsor
               ...
               LEFT  JOIN patient_records             ON cr_lKeyID            = sp_lClientID
   ...
   ---------------------------------------------------------------------*/
      ...
      $strOut = "
             ...
             sponpeep.pe_strCity    AS City,         sponpeep.pe_strState AS State,
             sponpeep.pe_strCountry AS Country,      sponpeep.pe_strZip   AS Zip,
   ...
   function strExportFields_People(){
      return('
             ...
             peepTab.pe_strCity    AS City,         peepTab.pe_strState AS State,
             peepTab.pe_strCountry AS Country,      peepTab.pe_strZip   AS Zip,
   ...
   function strExportFields_Biz(){
      return('
             ...
             bizTab.pe_strCity  AS City,         bizTab.pe_strState AS State,
             bizTab.pe_strCountry AS Country,    bizTab.pe_strZip   AS Zip,
             bizTab.pe_strPhone AS Phone,        bizTab.pe_strCell  AS Cell,
   ...
   ---------------------------------------------------------------------*/
      ...
      return("
               ...
               donor.pe_strState                    AS State,
               donor.pe_strCountry                  AS Country,
               donor.pe_strZip                      AS Zip,
...
--             csh_lStatusID                        AS `Status Entry ID`,
          ...
          --   defSCat.csc_strCatName               AS `Default Status Category Name`,
             ...
             cl_strState       AS `Location State`,
             cl_strPostalCode  AS `Location Postal Code`,

             cr_strAddr1       AS `Address 1`,
             cr_strAddr2       AS `Address 2`,
             cr_strCity        AS City,
             cr_strState       AS State,
