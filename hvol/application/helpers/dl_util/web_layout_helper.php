...
/* Typical usage:
      ...
      $attributes->lTableWidth      = 900;   // set to null to avoid the dancing blocks
      $attributes->lUnderscoreWidth = 300;
      $attributes->divID            = 'groupDiv';      // set to null for no hide/show
      $attributes->divImageID       = 'groupDivImg';   // set to null for no hide/show
...
---------------------------------------------------------------------*/
   ...
   if (is_null($attributes)){
      ...
      // dancing as the block is opened/closed; set table width null to not use the 
      // width specification.
