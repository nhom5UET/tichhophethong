...
var bool = true;
var i = 0;
//alert (document.forms.newTest.tname.value.substring(0,2));
if (document.forms.newTest.tname.value==""  && document.forms.newTest.tname.value.length==0)
{
	alert ("Invalid Test Name, try agin!");
	document.forms.newTest.tname.focus();
	return false;
}

else if (document.forms.newTest.tname.value.length>0 && document.forms.newTest.tname.value.substring(0,1)==" ")
{		
	alert ("Invalid Test Name, try agin!");
	document.forms.newTest.tname.focus();
	return false;
...
if(document.forms.newTest.tcost.value=="")
{
	alert("incvalid cost, try again!");
	document.forms.newTest.tcost.focus();
	return false;
}

for (var i=0;i<document.forms.newTest.tcost.value.length;i++)
{
  temp=document.forms.newTest.tcost.value.substring(i,i+1)

   if (validDigits.indexOf(temp)==-1)
   {
    alert("Invalid cost, try again!")
	document.forms.newTest.tcost.focus();
    return false
   }
 }
