  ...
  <tr> 
    ...
    <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<table width="99%" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                        <td height="25"   class="topDotedborder"><div class="genHeadingFont">Audit 
                          the test</div>
                        </td>
                    </tr>
                    <tr>
...
<%if(pt.isPicExist()){
    ...
    out.write("../images/na.jpg");
                            ...
                            <tr> 
                              <td width="153" class="genBFont">Test Name</td>
                              <td width="90" class="genBFont">Request Date</td>
                              <td width="70" class="genBFont">Audit</td>
                            </tr>
                            <% 
    RadTestAuditInfo radTests;
    ArrayList radTestsList;
    Iterator radTestsIt = null;
    try {
        int ptId = Integer.parseInt(request.getParameter("pid"));
        radTestsList = radData.getPtRadTestList(ptId);
        ...
        radTests = (RadTestAuditInfo)radTestsIt.next(); 
        testId = Integer.valueOf(radTests.getTestId()).toString();
        testReqId = Integer.valueOf(radTests.getTestReqId()).toString();
        
    %>
                            <tr> 
                              <td class="topborder"><div class="genFont"><%=radTests.getTestName() %></div></td>
                              <td class="topborder"><div class="genFont"><%=radTests.getTestReqDate() %></div></td>
                              <td class="topborder"><div class="genFont"><a href="RadTestAudit?testReqId=<%=testReqId %>&testId=<%=testId %>">Audit</a></div></td>
                            </tr>
                            <%   
       }
    }catch(Exception ex)
