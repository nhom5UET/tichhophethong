                            ...
                            <tr> 
                              <td colspan="3" class="genBFont"> <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  ...
                                  <tr> 
                                    ...
                                    <td class="genFont"><%=pt.getFirstName()%> 
                                      <%=pt.getLastName()%></td>
...
<%if(pt.isPicExist()){
    ...
    out.write("../images/na.jpg");
                            ...
                            <tr>
                              <td colspan="3"  class="topDotedborder"><div class="genHeadingFont">Get Reports Here</div></td>
                            </tr>
                            <tr bgcolor="#EFEFEF"> 
                              <td width="357" class="genBFont">Test Name</td>
                              <td class="genBFont"  width="362">Request Date</td>
                              <td class="genBFont" width="248">Get Report</td>
                            </tr>
                            <% 
    PthTestReportInfo pthTests;
    ArrayList pthTestsList = null;
    Iterator pthTestsIt = null;
    try {
        int ptId = Integer.parseInt(request.getParameter("pid"));
        pthTestsList = pthData.getPthTestReportInfo(ptId);
      ...
      String testReqId= "";
        ...
        pthTests = (PthTestReportInfo)pthTestsIt.next(); 
 ...
 %>
                            <tr> 
                              ...
                              <td class="topborder"> <div class="genFont"> <a href="PthTestReportView?pid=<%=request.getParameter("pid")%>&testId=<%=testId%>&testReqId=<%=testReqId%>">View 
                                  Report</a></div></td>
                            </tr>
                            <%   
       }
