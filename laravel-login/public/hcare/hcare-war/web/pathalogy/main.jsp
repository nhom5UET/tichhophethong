  ...
  <tr> 
    ...
    <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td width="992" background="../pathalogy/images/pixi_bg.gif" class="genArlBFont">Pathology 
            : Home</td>
		...
		<table width="99%" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                        ...
                        <div class="genHeadingFont">Patholoy Home </div></td>
                    </tr>
                    <tr>
                      <td>
					  ...
					  <!------------------>
<br><br><br>
					       <h1>Welcome to Pathology Department</h1>
						   <br><br><br>
