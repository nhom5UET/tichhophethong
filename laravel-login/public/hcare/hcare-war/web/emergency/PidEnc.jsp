        ...
        <table  border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="992" background="../images/pixi_bg.gif" class="genArlBFont">Emergency 
            : Registration Module</td>
                                    ...
                                    <tr>
                                        <td height="60" valign="top" colspan="2"> 
                                            ...
                                            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="24"></td>
                                                    <td class="topDotedborder"><div class="genHeadingFont">Old 
                          Patient Encounter:</div></td>
                                                </tr>
                                            </table>
                ...
                <td width="96%"><form name="pidEnc" method="post" action="PtActions.jsp" onSubmit="return validateForm (pidEnc);"> 
