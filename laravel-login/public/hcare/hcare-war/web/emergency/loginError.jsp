...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0">
        <form action="login"  onsubmit="return validateForm (login);" name = "login">
        <table  border="0" cellspacing="0" cellpadding="0">
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="992" background="images/pixi_bg.gif" class="genArlBFont">Emergency : Authentication </td>
              ...
              <tr>
                <td colspan="3"><table class="normalBorderTable" width="100%" cellpadding="0">
                    <tr>
                      <td align="center"><br>
					  You are not authorized to view 
                        <br />
                      <!-------end working table---------->                      </td>
