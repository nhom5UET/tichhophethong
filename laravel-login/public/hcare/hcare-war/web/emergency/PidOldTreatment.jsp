...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Select patient for previous treatments</title>
        <link href="../images/styles.css" rel="stylesheet" type="text/css" />
		<script language="javascript" src="scripts/PidOldTreatment.js"></script>
    </head>    
        ...
        <table  border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="992" background="../images/pixi_bg.gif" class="genArlBFont">Emergency 
            : Patient Treatment</td>
                                    ...
                                    <tr>
                                        <td height="60" valign="top" colspan="2"> 
                                            ...
                                            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="24"></td>
                                                    <td class="topDotedborder"><div class="genHeadingFont">View 
                          Previous Treatment Record:</div></td>
                                                </tr>
                                            </table>
                ...
                <td width="96%">
				<form name="pidOldTreat" method="post" action="ShowEncounters.jsp" onsubmit="return validateForm (pidOldTreat);">
              <table width="40%" border="0" class="mainTable">
                ...
                <tr>
                        <td class="genBFont">Enter PID:</td>
