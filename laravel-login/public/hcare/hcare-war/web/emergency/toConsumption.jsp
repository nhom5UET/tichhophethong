...
//if (session.getAttribute ("login").equals ("no"))
    ...
    else if (authResult > 0)
    {
        ...
        previlige = aRemote.authorizedUser (authResult , "reportPharmConsum");
        
        if (previlige == 0)
        {
            session.setAttribute("reportPharmConsum","no");
            response.sendRedirect ("login.jsp");
        }
        else if (previlige > 0)
        {
            session.setAttribute("reportPharmConsum","yes");
        }
...
<SCRIPT>document.onclick=function() {document.getElementById("popFrame").style.visibility="hidden";}</SCRIPT>
       <form  name="stockRemport"  action="consumption.jsp"  method="post">
    ...
    <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td width="675" rowspan="2" background="images/pixi_bg.gif" class="genArlBFont">Emergency 
              : Pharmacy Stock Consumption </td>			 <%
...
%>
            <td width="297" background="images/pixi_bg.gif"  class="genLoginTag" align="right">Welcome, <%=userName%>/td>
...
<%=empName%> (<%=designation%>) - <a href="Logout" class="small">Logout</a>
          ...
          <tr> 
            <td  colspan="4"> <table width="100%"   cellpadding="0"  cellspacing="0" class="normalBorderTable">
                <tr> 
                  <td height="173" valign="top" align="center"> <table width="70%"  border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td  class="genBFont">&nbsp;</td>
                        <td colspan="2" class="genFrontFont">&nbsp;</td>
                      </tr>
                      <tr> 
                        <td colspan="3"  class="genBFont">Pharmacy Stock Consumption 
                        </td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td class="genBFont">&nbsp;</td>
                        <td colspan="2" class="genFrontFont"><input type="submit" name="Submit" value="View"  class="btnFormat"/></td>
                      </tr>
                    </table></td>
                </tr>
              </table></td>
