...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0">
        ...
        <form action="RadLogin"   name = "login" method="post">
                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr> 
                            ...
                            <%
                                ...
                                %>
                            <td width="264" background="../images/pixi_bg.gif"  align="right"><div class="genLoginTag">Welcome, <%=userName%> </div></td>
                            <td width="10" rowspan="2"><img src="../images/right.gif"  height="32" /></td>
                        </tr>
                        <tr>
                            <td height="14" align="right"  bgcolor="#51A4D8"><div class="genLoginTag">
                                <%if (empName != null){%>
                                <%=empName%> (<%=designation%>) - <a href="RadLogout" class="small">Logout</a>
                                <%}%>
                            </div></td>
                        </tr>
                        <tr> 
