...
<tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="5" height="281">
        ...
        <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
          ...
          <a href="radSearch.jsp?searchFor=Discount" target="mainFrame" >Discount </a></span></td>
        </tr>
        ...
        <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
          <td height="19"  class=topborder ><span class="genFont">
        <a href="radSearch.jsp?searchFor=Fee" target="mainFrame" >Fee</span></td>
        </tr>
        ...
        <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="radSearch.jsp?searchFor=result" target="mainFrame" >Results</span></td>
        </tr>
        ...
        <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="radSearch.jsp?searchFor=report" target="mainFrame" >Reports</span></td>
        </tr>
        ...
        <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="radTestDomainAdd.jsp" target="mainFrame" >Add New Test</span></td>
        </tr>
            ...
            <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="radTestEditList.jsp" target="mainFrame" >Edit Test</span></td>
        </tr>
            ...
            <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="radSearch.jsp?searchFor=TestAudit" target="mainFrame" >Test Audit</span></td>
        </tr>
            ...
            <TR class=hand onmouseover="this.style.backgroundColor='#ffffff'" 
              ...
              onmouseout="this.style.backgroundColor='#F1F1F1';">
        <td height="19"  class=topborder ><span class="genFont">
        <a href="RadTestPlan" target="mainFrame" >Test Plan</span></td>
        </tr>
