 ...
 * @version
 */
public class CurrentPharmStockReport extends HttpServlet {
    ...
    public JFreeChart getBarChart() {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                dataset.setValue(medicineStock.getQty(),"Consumed Qantity",medicineStock.getName());
            }
        ...
        if (shift.equals("M")) {
            ...
            shiftdisplay = "Evening";
        }else if (shift.equals("N")) {
            shiftdisplay = "Noon";
        }
        
        
        return ChartFactory.createBarChart3D("Current Pharmacy Stock at "+shiftdisplay,
                "Medicines", "Consumed Quantity", dataset,
    ...
    throws ServletException, IOException {
        ...
        convertToPdf(getBarChart(), 700, 800, request, response, "GET");
    }
    ...
    throws ServletException, IOException {
        convertToPdf(getBarChart(), 700, 800, request, response, "POST");
    }
