 ...
 * @version
 */
public class RegFromEachCityReport extends HttpServlet {
    ...
    public JFreeChart getBarChart() {
       ...
       try {
        ...
        ArrayList cityList = new EJBAccessPoint().lookupRepEmgBean().regFromEachCityBw(frmDate,tDate);
        ...
        return ChartFactory.createPieChart3D("Registered Patients From Each City\n" + "From: " + fromDate +"   To: " + toDate, dataset,
                                             true, true, false);
