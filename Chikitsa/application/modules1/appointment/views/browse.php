				...
				<div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="padding:0;">
						...
						<?php
							...
							$today_day = date("d");
						?>
						<a href="<?=site_url('appointment/index/'.$today_year.'/'.$today_month.'/'.$today_day);?>" class="btn btn-sm square-btn-adjust btn-success">Today</a>
						</div>
					</div>
				</div>
			</div>
								...
								<?php }
									...
									foreach ($appointments as $appointment) {
										...
										for($column = 1;$column <= 10;$column = $column + 1){
											$cell_available = FALSE;
											//Check if cell is empty
											//echo "cell[$doctor_id][$start_position][$column]<br/>";
